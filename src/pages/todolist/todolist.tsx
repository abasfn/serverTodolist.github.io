        ...
        <>
            <div className='mx-auto p-4 container'>
                <div className='grid grid-cols-5 m-auto w-4/5 mb-8'>
                    ...
                    <div>
                        <button onClick={handelAddButton} className='ml-3'><img src='images/Emoticon/icons8-add-48.png' /></button>
                    </div>
                </div>
            </div>
                ...
                {contaner.map((item, index) => {
                    return (
                        <div className='grid grid-cols-5 m-auto w-4/5 mb-4'>
                            ...
                            <div>
                                <button onClick={() => handeRemoveList(item)} className='ml-3 w-12'><img src='images/Emoticon/icons8-delete-128.png' /></button>
                                <button onClick={() => handeEditList(item, index)} className='ml-3 w-12'><img src='images/Emoticon/icons8-edit-property-80.png' /></button>
                            </div>
                        </div>
                    )
                })}
